...
from dummyapp.tivol_migrations.directors_migration import DirectorsMigration
from dummyapp.tivol_migrations.film_makers_migration import FilmMakerMigration
from dummyapp.tivol_migrations.movies_migration import MoviesMigration
...
class CustomEntryPoint(EntryPoint):
    ...
    def register_migrations(self):
        ...
        self.add_migration_handler(DirectorsMigration)
        self.add_migration_handler(MoviesMigration)
